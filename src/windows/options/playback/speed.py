...
class Speed(Popup):
    def __init__(self, parent, main_app):
        ...
        Label(self, text=main_app.text_content["options_menu"]["playback_menu"]["speed_settings"]["sub_text"]).pack(side=TOP, pady=10)
        ...
        Button(buttonArea, text=main_app.text_content["global"]["confirm_button"], command=lambda: self.setNewSpeedNumber(setNewSpeedInput.get(), main_app),
